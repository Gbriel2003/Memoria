...
public class Utilities {
    ...
    private final List<Match> ok = new ArrayList<>();
    ...
    public void paintImage(JButton btn, int value) {
        try {
            btn.setIcon(new ImageIcon(getClass().getResource("/Imagenes/0" + value + ".png")));
    ...
    public void imgStart() {
        paintImage(Principal.boton1, 9);
        paintImage(Principal.boton2, 9);
        paintImage(Principal.boton3, 9);
        paintImage(Principal.boton4, 9);
        paintImage(Principal.boton5, 9);
        paintImage(Principal.boton6, 9);
        paintImage(Principal.boton7, 9);
        paintImage(Principal.boton8, 9);
    }
